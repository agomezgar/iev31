...
<table width="50%" border="1" align="center">
  <tr>
    <td><div align="center">
      ...
      <p><strong>INFORME DE LA EVALUACI&Oacute;N FINAL ORDINARIA</strong></p>
...
$result3=mysql_query("select * from informebach3eval where id=$alumno",$link);
...
mysql_free_result($result3);
    ...
    $result4=mysql_query("select * from informebach3eval where id='$alumno'",$link);
