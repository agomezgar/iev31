...
$pend=$_POST['pend'];
 ...
 $result4=mysql_query("UPDATE informebach3eval SET grupo='$grupo',alumno='$alumno',aspectos='$aspectos',m1='$m1', m2='$m2',m3='$m3',m4='$m4',m5='$m5',m6='$m6',m7='$m7',m8='$m8',ob='$ob',pend='$pend' WHERE id ='$id'",$link);
mysql_free_result;
echo "¡Grabado!";
