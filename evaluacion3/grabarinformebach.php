...
mysql_query("insert into informebach3eval (id,grupo,alumno,aspectos,m1,m2,m3,m4,m5,m6,m7,m8,ob,pend) values ('$id','$grupo','$alumno','$aspectos','$m1','$m2','$m3','$m4','$m5','$m6','$m7','$m8','$ob','$pend')",$link);
mysql_free_result;
echo "¡Grabado!";
