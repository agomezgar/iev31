...
<table width="50%" border="1" align="center">
  <tr>
    <td><div align="center">
      ...
      <p><strong>INFORME DE LA EVALUACI&Oacute;N FINAL EXTRAORDINARIA</strong></p>
...
$result3=mysql_query("select * from informebachexteval where id=$alumno",$link);
while($comprueba= mysql_fetch_array($result3)) {
$d=$comprueba['id'];}
if (!isset($d)){echo "En este momento no constan medidas de ampliacion y/o refuerzo"; $destino="grabarinformebach.php";}
if (isset($d)){echo "Ya se ha rellenado un informe sobre la evaluacion del alumno; rellenar este informe supone introducir cambios ";$destino="actualizarinformebach.php";}

mysql_free_result($result3);

  
    $result4=mysql_query("select * from informebachexteval where id='$alumno'",$link);
...
<fieldset>
<legend><strong>ASPECTOS EN LOS QUE HA MEJORADO Y EN LOS QUE NECESITA MEJORAR</strong></legend>
<textarea name="aspectos" cols="100%" rows="4" id="label"><?php echo urlencode($aspectos); ?></textarea>
</fieldset>
<fieldset>
