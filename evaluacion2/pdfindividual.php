...
$pdf->Ln(5);
$pdf->SetFont('Arial','',10);
$pdf->Multicell(180,5,'La programación de objetivos, contenidos y criterios de evaluación trabajados en el trimestre, en cada una de las materias, están a disposición de las familias en la secretaría del centro');
$pdf->Ln(5);
$pdf->SetFont('Arial','B',10);
